...
public class MainMazeDriver extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				MainMazeDriver view = new MainMazeDriver();
